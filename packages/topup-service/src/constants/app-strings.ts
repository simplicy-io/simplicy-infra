...
export const SERVICE = 'topup-service';
export const PUBLIC = 'public';
export const APP_NAME = 'topup-service';
...
export const SIMPLICY_STRIPE_DEFAULTS = {
  currency: 'eur',
  description: 'Simplicy Topup.',
};
export const SIMPLICY_STRIPE_ADDRESS_DEFAULTS = {
